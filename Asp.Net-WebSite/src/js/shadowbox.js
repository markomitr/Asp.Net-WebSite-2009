...
(function(){
    ...
    var options = {
         ...
         */
        loadingImage:       'Images/jsSliki/loading.gif',
         ...
         */
        overlayBgImage:     'Images/jsSliki/overlay-85.png',
        ...
        text:           {
            ...
            close:      '<span class="shortcut">З</span>атвори',

            next:       '<span class="shortcut">С</span>ледна',

            prev:       '<span class="shortcut">П</span>ретходна',
